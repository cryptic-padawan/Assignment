...
city_states['Korea (north)'] = '|yongyang||Chagang-do|Hamgyong-bukto|Hamgyong-namdo|Hwanghae-bukto|Hwanghae-namdo|Kaesong-si|Kangwon-do|Najin Sonbong-si|Nampo-si|yongan-bukto|Pyongan-namdo|Pyongyang-si|Yanggang-do';
...
function set_city_state(oCountrySel, oCity_StateSel)
{
	...
	{
		oCity_StateSel.disabled = false;
        oCity_StateSel.options[0] = new Option('SELECT City/State','');
